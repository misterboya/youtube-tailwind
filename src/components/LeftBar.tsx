...
export const LeftBar = () => {
    return <div className="bg-gray-300 w-48 hidden md:block">
      <BarWithIcon />
      <BarWithIcon />
      <BarWithIcon />
      <Line />
...
function BarElement({icon, title}: {icon: any; title: string;}) {
    return <div className="w-full rounded-xl bg-slate-300 hover:bg-gray-300 flex w-48 p-2 m-2 cursor-pointer">
        <div className="pr-2">
            {icon}
        </div>
        <div>
